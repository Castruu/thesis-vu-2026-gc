The garbage collectors, the IJVM, and the experimental design are my own work, implemented without any AI-generated code.
Generative AI (Anthropic's Claude, via Claude Code) was used to support the following tasks:
